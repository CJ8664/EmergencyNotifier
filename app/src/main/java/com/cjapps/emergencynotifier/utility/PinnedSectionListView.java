...
import com.cjapps.emergencynotifier.BuildConfig;
...
public class PinnedSectionListView extends ListView {
	...
	/** List adapter to be implemented for being used with com.cjapps.playinsync.PinnedSectionListView adapter. */
        ...
        if (visible) {
            if (mShadowDrawable == null) {
                ...
                mShadowDrawable = new GradientDrawable(Orientation.TOP_BOTTOM,
                        new int[] { Color.parseColor("#ffff4444"), Color.parseColor("#ffff4444"), Color.parseColor("#ffff4444")});
                mShadowHeight = (int) (2 * getResources().getDisplayMetrics().density);
